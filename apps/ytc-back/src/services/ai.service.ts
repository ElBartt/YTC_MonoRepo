...
export class OpenAIService {
    ...
    private readonly example1 =
        'Trop contente de te revoir, je souhaite que tu n ai plus le besoin de faire une pause dans l avenir mais surtout ne te force pas car ta santé passe avant tout Bisousss <3';
    private readonly result1 = '1';
    private readonly example2 = 'Le son de ton micro été vraiment trop bas !';
    private readonly result2 = '4';
    private readonly example3 =
        "Excellent concept je me suis taper des barres et c'est très rare que je commente une vidéo. Tu devrais faire un tour des villes de France avec ce concept 👍";
    private readonly result3 = '3';
    private readonly example4 =
        "Merci énormément d'apporter la bonne humeur comme ça je me tape jamais autant de fou rire que devant vos vidéos ! Je pense qu'on vous le dit beaucoup mais vous êtes incroyables !";
     ...
     */
    async ClassifyComment(): Promise<string> {
        return '1'; // Safe Lock !
